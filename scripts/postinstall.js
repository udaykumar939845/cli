...
const errGlobal = `Installing ${process.env.npm_package_name || 'this CLI'} as a global module is not supported.
...
async function main() {
  ...
  const pkgName = pkg.name || "CLI";
  console.info(`Installed ${pkgName} successfully`);
}
